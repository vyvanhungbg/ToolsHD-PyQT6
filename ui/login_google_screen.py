...
class LoginGoogleScreen(BaseWidget):
    ...
    def google_login(self):
        ...
        if token_data:
            try:
                ...
                if not token_check.is_token_valid(access_token) and is_internet_available(self):
                    creds = None
        ...
        if not creds:
            ...
            if creds_obj and creds_obj.token:
                ...
                self.stacked_widget.setCurrentIndex(1)  # 🔄 Chuyển sang màn Home
            else:
